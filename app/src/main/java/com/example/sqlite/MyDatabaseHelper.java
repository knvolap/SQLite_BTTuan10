...
import com.example.sqlite.bean.Note;
...
import java.util.List;
    ...
    public void createDefaultNotesIfNeed()  {
        ...
        if(count ==0 ) {
            Note note1 = new Note("Lập trình di động",
                    "Thực hành lập trình di dộng thứ 3 tiết 1-2");
            Note note2 = new Note("Lập trình web nâng cao",
                    "Thực hành lập trình web nâng cao thứ 3 tiết 3-4");
